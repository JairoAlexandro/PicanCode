  ...
  return (
    <div className="max-w-5xl mx-auto bg-gray-900 rounded-lg shadow-lg overflow-hidden">
      ...
      <div className="px-6 py-4 bg-black flex justify-around text-center">
        <div>
          <span className="block text-white font-bold text-lg">{posts.length}</span>
          <span className="text-gray-400 text-sm">Posts</span>
        </div>
        <div>
          <span className="block text-white font-bold text-lg">{user.followers}</span>
          <span className="text-gray-400 text-sm">Seguidores</span>
        </div>
        <div>
          <span className="block text-white font-bold text-lg">{user.following}</span>
